...
const {
  createAxiosInstance
} = require('../transports/axios')

const {
  performFetch
} = require('../transports/fetch')
...
class Client {
  ...
  async request(config = {}) {
    ...
    const profile =
      merged.rotateFingerprint ||
      merged.randomizeFingerprint
